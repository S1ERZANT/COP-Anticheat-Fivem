...
Config.Bypass = {"COPadmin","COPmod"}
Config.OpenMenuAllowed = {"COPadmin"}
Config.SpectateAllowed = {"COPadmin","COPmod"}
Config.ClearAreaAllowed = {"COPadmin"}
Config.BypassVPN = {"COPvpn"}
